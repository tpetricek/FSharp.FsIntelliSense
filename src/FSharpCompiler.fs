...
module SourceCodeServices =
  ...
  type CheckOptions(wrapped:obj) =
    ...
    member x.WriteInfo() = 
      printfn "[CHECKOPTIONS] ProjectFileName: %s, ProjectFileNames: %A, ProjectOptions: %A, IsIncompleteTypeCheckEnvironment: %A, UseScriptResolutionRules: %A" x.ProjectFileName x.ProjectFileNames x.ProjectOptions x.IsIncompleteTypeCheckEnvironment x.UseScriptResolutionRules
